...
function github_plugin_updater_test_init() {
	...
	if ( is_admin() ) { // note the use of is_admin() to double check that this is happening in the admin
		...
		$config = array(
			...
			'api_url' => 'https://api.github.com/repos/alecdewitz/run-sql-query',
			'raw_url' => 'https://raw.github.com/alecdewitz/run-sql-query/master',
			'github_url' => 'https://github.com/alecdewitz/run-sql-query',
			'zip_url' => 'https://github.com/alecdewitz/run-sql-query/archive/master.zip',
			'sslverify' => true,
			'requires' => '3.0',
			'tested' => '3.3',
			'readme' => 'README.md',
